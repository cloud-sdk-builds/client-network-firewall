...
[`@aws-sdk/client-network-firewall`](https://www.npmjs.com/package/@aws-sdk/client-network-firewall/v/3.1048.0).
...
- @aws-sdk/client-network-firewall - [https://cloud-sdk-builds.github.io/?sdk=client-network-firewall](https://cloud-sdk-builds.github.io/?sdk=client-network-firewall)
- @aws-sdk/client-network-firewall v3.1048.0 - [https://cloud-sdk-builds.github.io/?sdk=client-network-firewall&version=3.1048.0](https://cloud-sdk-builds.github.io/?sdk=client-network-firewall&version=3.1048.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall@3.1048.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nTM4dUeFon34299WC5xiGXz5IwExGDL3ayDszWxp0b4jFZlUFG0cTmUGmojvkfHb
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-network-firewall": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall@3.1048.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall@3.1048.0/index.min.mjs": "sha384-nTM4dUeFon34299WC5xiGXz5IwExGDL3ayDszWxp0b4jFZlUFG0cTmUGmojvkfHb"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-network-firewall";
...
```
https://github.com/cloud-sdk-builds/client-network-firewall/blob/refs/tags/3.1048.0/LICENSE
```
