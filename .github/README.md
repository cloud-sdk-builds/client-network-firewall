...
[`@aws-sdk/client-network-firewall`](https://www.npmjs.com/package/@aws-sdk/client-network-firewall/v/3.1047.0).
...
- @aws-sdk/client-network-firewall v3.1047.0 - [https://cloud-sdk-builds.github.io/?sdk=client-network-firewall&version=3.1047.0](https://cloud-sdk-builds.github.io/?sdk=client-network-firewall&version=3.1047.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall@3.1047.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UQNCCtVJ+3je72fd2QvZmenrmm+FKiq8ktFyXVy/Htu07fVF2dRbdyoNCwfWh9Bt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-network-firewall": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall@3.1047.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall@3.1047.0/index.min.mjs": "sha384-UQNCCtVJ+3je72fd2QvZmenrmm+FKiq8ktFyXVy/Htu07fVF2dRbdyoNCwfWh9Bt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-network-firewall/blob/refs/tags/3.1047.0/LICENSE
```
