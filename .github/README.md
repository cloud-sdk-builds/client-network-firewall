...
[`@aws-sdk/client-network-firewall`](https://www.npmjs.com/package/@aws-sdk/client-network-firewall/v/3.495.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall@3.495.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YdjcrhY1lTgayvb6jE+Bw6IfQU9QA2SHVl/Sh1GfjOuZWDK1gRlFIc94B29hJ5EV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-network-firewall": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall@3.495.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-network-firewall@3.495.0/index.min.mjs": "sha384-YdjcrhY1lTgayvb6jE+Bw6IfQU9QA2SHVl/Sh1GfjOuZWDK1gRlFIc94B29hJ5EV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-network-firewall/blob/refs/tags/3.495.0/LICENSE
```
